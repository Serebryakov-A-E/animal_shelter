        ...
        try {
            list.forEach(update -> {
                ...
                if ("/start".equals(text)) {
                    ReplyKeyboardMarkup replyKeyboardMarkup = telegramKeyboard.getReplyKeyboardMarkup();
                    SendMessage sendMessage = new SendMessage(chatId, "Hello").replyMarkup(replyKeyboardMarkup.resizeKeyboard(true));
